...
abstract final class AppTheme {
  ...
  static TextTheme cupertinoTextTheme = TextTheme(
    ...
    titleLarge: AppTheme.cupertinoLightTheme.textTheme.navTitleTextStyle
        .copyWith(fontSize: 20),
    titleMedium: AppTheme.cupertinoLightTheme.textTheme.navTitleTextStyle
        .copyWith(fontSize: 16),

    /// Default text
    bodyMedium: AppTheme.cupertinoLightTheme.textTheme.textStyle.copyWith(
      fontSize: 14,
    ),
    labelSmall: AppTheme.cupertinoLightTheme.textTheme.textStyle.copyWith(
